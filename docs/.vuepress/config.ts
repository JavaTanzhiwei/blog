...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
    ...
    base: '/bar/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
    ...
    themeConfig: {
        ...
        logo: '/img/smile.png', // 导航栏logo
        repo: 'JavaTanzhiwei', // 导航栏右侧生成Github链接
        ...
        author: {
            name: 'JavaTanzhiwei', // 必需
            link: 'https://gitee.com/JavaTanzhiwei', // 可选的
        },
            ...
            icons: [
              {
                ...
                title: '发邮件',
                link: 'mailto:tanzhiwei0526@163.com',
              },
              {
